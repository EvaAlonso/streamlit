...
st.title("Tipos de Textos en Streamlit")
st.header("Primer nivel de encabezado")
st.subheader("Segundo nivel de encabezado")

st.text("simplemnte texto")
st.markdown("### Texto")

st.caption("texto leyenda, pie")
...
st.latex(r"F = G * (m1 * m2) / (r ** 2)")

st.divider()
st.write("Texto debajo de la barra separadora")
